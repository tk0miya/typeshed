...
from docutils.nodes import Element, Node, NodeVisitor, Text, citation, citation_reference, footer, footnote, footnote_reference, header, pending, substitution_definition, substitution_reference, system_message, target
...
class Node:
    ...
    def traverse(self, condition: Optional[Any] = ..., include_self: bool = ..., descend: bool = ..., siblings: bool = ..., ascend: bool = ...) -> List[Node]: ...
...
class Element(Node):
    ...
    def extend(self, item: List[Node]) -> None: ...
...
class document(Root, Structural, Element):
    ...
    refnames: Dict[str, List[Node]] = ...
    refids: Dict[str, List[Node]] = ...
    nameids: Dict[str, str] = ...
    nametypes: Dict[str, bool] = ...
    ids: Dict[str, Node] = ...
    footnote_refs: Dict[str, footnote_reference] = ...
    citation_refs: Dict[str, citation_reference] = ...
    autofootnotes: List[Node] = ...
    ...
    document: document = ...
    def __init__(self, settings: SettingsSpec, reporter: Reporter, *args: Node, **kwargs: Any) -> None: ...
    def asdom(self, dom: Optional[Any] = ...) -> Any: ...
    def set_id(self, node: Node, msgnode: Optional[Node] = ...) -> str: ...
    def set_name_id_map(self, node: Node, id: str, msgnode: Optional[Node] = ..., explicit: Optional[bool] = ...) -> None: ...
    def set_duplicate_name_id(self, node: Node, id: str, name: str, msgnode: Node, explicit: bool) -> None: ...
    def has_name(self, name: str) -> bool: ...
    def note_implicit_target(self, target: Node, msgnode: Optional[Node] = ...) -> None: ...
    def note_explicit_target(self, target: Node, msgnode: Optional[Node] = ...) -> None: ...
    def note_refname(self, node: Node) -> None: ...
    def note_refid(self, node: Node) -> None: ...
    ...
    def note_substitution_def(self, subdef: substitution_definition, def_name: str, msgnode: Optional[Node] = ...) -> None: ...
